...
import useAuthStore from "../../../utils/stores/auth/useAuthStore.js";
    ...
    <div className="fixed top-0 left-0 lg:left-64 right-0 h-16 bg-white border-b border-gray-200 shadow-sm z-40 px-4 sm:px-6 flex items-center justify-between lg:justify-end">
      ...
      <div className="flex items-center gap-3 sm:gap-5">
        ...
        <div className="dropdown dropdown-end">
          ...
          <ul className="dropdown-content menu p-1 shadow-lg bg-white rounded-xl w-36 mt-1 border border-gray-200 z-50">
            <li>
              <button
                onClick={handleLogout}
                className="flex items-center gap-2 text-red-600 font-medium rounded-lg hover:bg-red-50"
              >
                <LogOut size={16} />
                Logout
              </button>
