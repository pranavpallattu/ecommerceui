// src/components/dashboard/TopProductsSection.jsx
export default function TopProductsSection({ bestProducts }) {
  return (
    <div className="bg-white rounded-xl shadow p-4 sm:p-6 border border-gray-100">
      <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Best Selling Products</h2>
      {bestProducts.length === 0 ? (
        <p className="text-center py-8 sm:py-12 text-gray-400 text-sm sm:text-base">No sales data yet</p>
      ) : (
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-gray-500">{p.totalSold} units sold</p>
                </div>
              </div>
