  ...
  return (
    <div className="navbar bg-white border-b border-gray-200 px-2 sm:px-4 py-3 z-50 relative">
      <div className="navbar-start">
        ...
        <Link
          to="/"
          className="btn btn-ghost text-xl sm:text-2xl font-bold text-blue-600 px-2 sm:px-4"
        >
          oneBazaar
        </Link>
      </div>
      ...
      <div className="navbar-end flex items-center gap-1 sm:gap-2 md:gap-3">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <div className="dropdown dropdown-end">
            <label
              tabIndex={0}
              className="btn btn-ghost btn-circle w-10 h-10 min-h-10 sm:w-11 sm:h-11 sm:min-h-11"
            >
              <User
                size={20}
                className="text-gray-700 sm:w-[22px] sm:h-[22px]"
